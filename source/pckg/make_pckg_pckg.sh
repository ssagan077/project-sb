#!/bin/bash
## This script builds a deb package to deploy a server with a local deb-package repository (wm-pckg-srv)
## deb-package includes configuration files for nginx, prometheus exporters, ... And also dependencies
