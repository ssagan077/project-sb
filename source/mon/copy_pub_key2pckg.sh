...
## This action is necessary to exchange data with the CA server through the exchange folders hosted on the vm-pckg-srv >## In order for the copying procedure to be successful,
